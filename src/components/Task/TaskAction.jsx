...
const TaskAction = () => {
  return (
    <div className="container px-2 mx-auto grid gap-4 grid-cols-2 md:grid-cols-4">
      ...
      <button className="px-4 py-2 mt-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-amber-600 rounded-md sm:mt-0 sm:mx-2 hover:bg-amber-500 focus:outline-none focus:ring focus:ring-amber-300 focus:ring-opacity-40">
        Add Task
      </button>
